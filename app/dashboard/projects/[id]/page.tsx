            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <div className="flex flex-wrap gap-3">
                {permissions?.canCreateTasks && (
                  <Button onClick={() => setIsTaskModalOpen(true)} size="sm" className="shadow-sm">
                    <PlusIcon className="mr-2 h-4 w-4" /> Yeni Görev
                  </Button>
                )}
                {permissions?.canEditProject && (
                  <Button variant="outline" onClick={() => setIsProjectModalOpen(true)} size="sm" className="shadow-sm">
                    <Pencil1Icon className="mr-2 h-4 w-4" /> Projeyi Düzenle
                  </Button>
                )}
                {permissions?.canDeleteProject && (
                  <Button variant="destructive" onClick={() => setIsDeleteModalOpen(true)} size="sm" className="shadow-sm">
                  ...
                  {members.length === 0 ? (
                    ...
                    <div className="grid gap-4">
                      {members.map((member) => (
                        <div
                          key={member.id}
                          className="flex items-center justify-between p-4 rounded-lg bg-gray-50/50 hover:bg-gray-50 transition-colors"
                        >
